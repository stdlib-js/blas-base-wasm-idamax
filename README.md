...
```javascript
idamax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-idamax-wasm@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var idamax = require( 'path/to/vendor/umd/blas-base-idamax-wasm/index.js' )
```
