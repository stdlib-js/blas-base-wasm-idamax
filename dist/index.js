...
var O=require('@stdlib/assert-is-wasm-memory/dist'),y=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),q=require('@stdlib/wasm-module-wrapper/dist'),g=require('@stdlib/error-tools-fmtprodmsg/dist'),j=l();function t(e){if(!(this instanceof t))return new t(e);if(!O(e))throw new TypeError(g('nullH0',e));return q.call(this,j,e,{env:{memory:e}}),this}S(t,q);y(t.prototype,"main",function(r,a,i){return this._instance.exports.c_idamax(r,a,i)});y(t.prototype,"ndarray",function(r,a,i,o){return this._instance.exports.c_idamax_ndarray(r,a,i,o)});m.exports=t
